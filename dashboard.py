...
st.subheader("Analisis kinerja penjualan perusahaan dalam beberapa tahun terakhir.")
...
st.subheader("Pada jam berapa waktu paling ramai dan paling sepi dalam hal peminjaman?")
...
st.pyplot(fig)
st.subheader("Musim apa yang paling sering digunakan untuk penyewaan?")
...
st.subheader("Perbandingan antara pelanggan yang terdaftar dan pengguna casual")
